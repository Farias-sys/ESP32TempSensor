...
#define MQTT_TEMPERATURE_TOPIC "farias_ifrjesp32group_ifrjcnit_heatsensor"
#define MQTT_TEMPERATURE_STATUS_TOPIC "farias_ifrjesp32group_ifrjcnit_temperaturealert"
